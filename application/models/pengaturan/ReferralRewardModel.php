...
class ReferralRewardModel extends Render_Model
{
    public function getAllData($draw = null, $show = null, $start = null, $cari = null, $order = null)
    {
        ...
        ");
        $this->db->from("referral_nominal a");
    ...
    public function insert($user_id, $nama, $nominal, $keterangan)
    {
        ...
        // Insert data
        $execute = $this->db->insert('referral_nominal', $data);
    ...
    public function update($id, $user_id, $nama, $nominal, $keterangan)
    {
        ...
        $execute = $this->db->update('referral_nominal', $data);
        return  $execute;
    }
    ...
    {
        // Delete users
        $exe = $this->db->where('id', $id)->update('referral_nominal', [
            'status' => 3,
            'deleted_by' => $user_id,
