$(function () {
    function dynamic() {
        ...
        const new_table = table_html.DataTable({
            "ajax": {
                "url": "<?= base_url()?>pengaturan/ReferralReward/ajax_data/",
                "data": null,
                "type": 'POST'
            },
            "processing": true,
    ...
    $("#btn-tambah").click(() => {
        $("#tambahModalTitle").text("Tambah Referral Nominal Reward");
        $('#id').val('');
        $('#nama').val('');
        $('#nominal').val('');
        $('#keterangan').val('');
    ...
    $("#fmain").submit(function (ev) {
        ...
        $.ajax({
            method: 'post',
            url: '<?= base_url() ?>pengaturan/ReferralReward/' + ($("#id").val() == "" ? 'insert' : 'update'),
            data: form,
            cache: false,
            contentType: false,
            processData: false,
    ...
    $("#faktifkan").submit(function (ev) {
        ...
        $.ajax({
            method: 'post',
            url: '<?= base_url() ?>pengaturan/ReferralReward/aktifkan',
            data: form,
            cache: false,
            contentType: false,
            processData: false,
    ...
    $('#OkCheck').click(() => {
        ...
        $.ajax({
            method: 'post',
            url: '<?= base_url() ?>pengaturan/ReferralReward/delete',
            data: {
                id: id
            }
        }).done((data) => {
...
const Ubah = (datas) => {
    ...
    $("#tambahModalTitle").text("Ubah Referral Nominal Reward");
}
