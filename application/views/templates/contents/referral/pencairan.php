<div class="card card-primary card-outline">
    <div class="card-header">
        <div class="d-flex justify-content-between w-100">
            <h3 class="card-title">List Pencairan Referral</h3>
        </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="fmain" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-12" id="foto_con">
                            <div class="form-group">
                                <label for="foto">Bukti</label>
                                <input type="file" class="form-control" id="foto" name="foto" placeholder="Bukti" required />
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
