<div class="card card-primary card-outline">
    <div class="card-header">
        <div class="d-md-flex justify-content-between align-items-center w-100">
            <div>
                <a href="<?= base_url() ?>kelas/materi/<?= $detail['kelas_id'] ?>" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
            </div>
            <div>
                <h3 class="card-title">List Sub Materi <span class="font-weight-bold"><?= $detail['nama'] ?></span></h3>
            </div>
            <div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="fmain" method="post">
                    ...
                    <input type="hidden" class="form-control" id="kelas_id" name="kelas_id" value="<?= $detail['kelas_id'] ?>" placeholder="" required />
                    <input type="hidden" class="form-control" id="materi_id" name="materi_id" value="<?= $detail['id'] ?>" placeholder="" required />
