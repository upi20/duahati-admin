        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="fmain" method="post">
                    ...
                    <div class="form-group">
                        <label for="url">Alamat Video Yotube Tutorial</label>
                        <input type="text" class="form-control" id="url" name="url" placeholder="Alamat Video Yotube Tutorial" required />
                    </div>
                    <div class="form-group">
