            ...
            <div class="modal-body">
                <form action="" id="fmain" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="kode_refeal">Kode Refeal (Member Baru)</label>
                                <input type="text" class="form-control" id="kode_refeal" name="kode_refeal" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="no_telepon" class="form-control" id="no_telepon" name="no_telepon" placeholder="No Whatsapp" required />
                            </div>
                        </div>
