...
class Posisi extends Render_Controller
{
    ...
    public function index()
    {
        ...
        $this->breadcrumb_3_url = base_url() . 'master/posisi';

        // content
        $this->content      = 'master/posisi';
    ...
    {
        $config['upload_path']          = './files/posisi/';
    ...
    function __construct()
    {
        ...
        $this->load->model("master/posisiModel", 'model');
