...
class Stadion extends Render_Controller
{
    ...
    public function index()
    {
        // Page Settings
        $this->title = 'Stadion';
        $this->navigation = ['Master', 'Stadion'];
        ...
        $this->breadcrumb_3 = 'Stadion';
        $this->breadcrumb_3_url = base_url() . 'master/stadion';

        // content
        $this->content      = 'master/stadion';
    ...
    {
        $config['upload_path']          = './files/stadion/';
    ...
    public function getStadion()
    {
        ...
        $result = $this->model->getStadion($id);
        $code = $result ? 200 : 500;
    ...
    public function insert()
    {
        ...
        $result = $this->model->insert($team, $nama, $status);
    ...
    public function update()
    {
        ...
        $nama = $this->input->post("nama");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $team, $nama, $status);
        $this->db->trans_complete();
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    function __construct()
    {
        ...
        $this->load->model("master/stadionModel", 'model');
