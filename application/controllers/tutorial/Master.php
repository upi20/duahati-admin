...
class Master extends Render_Controller
{
    ...
    {
        // Page Settings
        $this->title = 'List Tutorial';
        $this->navigation = ['Tutorial'];
        $this->plugins = ['datatables'];

        // Breadcrumb setting
        $this->breadcrumb_1 = 'Dashboard';
        $this->breadcrumb_1_url = base_url();
        $this->breadcrumb_3 = 'tutorial';
        $this->breadcrumb_3_url = '#';
        // content
        $this->content      = 'tutorial/list';
    ...
    public function insert()
    {
        ...
        $user_id = $this->id;
        $result = $this->model->insert($user_id, $nama, $url,  $keterangan, $foto, $status);
    ...
    public function update()
    {
        ...
        $status = $this->input->post("status");
        $user_id = $this->id;
        $result = $this->model->update($id, $user_id, $nama, $url, $keterangan, $foto, $status);
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    function __construct()
    {
        ...
        $this->photo_path = './files/tutorial/';
        $this->load->model("tutorial/MasterModel", 'model');
