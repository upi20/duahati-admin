...
class KursiBerhadiah extends Render_Controller
{
    ...
    public function index()
    {
        ...
        $this->navigation = ['Pertandingan', 'Kursi Berhadiah'];
        ...
        $this->breadcrumb_3 = 'Kursi Berhadiah';
        $this->breadcrumb_3_url = base_url() . 'pertandingan/kursi-berhadiah';

        // content
        $this->content      = 'pertandingan/kursi-berhadiah';
    ...
    {
        $config['upload_path']          = './files/kursiBerhadiah/';
    ...
    // dipakai Administrator |
    public function getKursiBerhadiah()
    {
        $id = $this->input->get("id");
        $result = $this->model->getKursiBerhadiah($id);
        $code = $result ? 200 : 500;
    ...
    public function insert()
    {
        ...
        $nomer_kursi = $this->input->post("nomer_kursi");
        $status = $this->input->post("status");
        $result = $this->model->insert($pertandingan, $member, $kategori, $nomer_kursi, $status);
    ...
    public function update()
    {
        ...
        $nomer_kursi = $this->input->post("nomer_kursi");
        $status = $this->input->post("status");
        $result = $this->model->update($id, $pertandingan, $member, $kategori, $nomer_kursi, $status);
        $this->db->trans_complete();
        $code = $result ? 200 : 500;
        $this->output_json(["data" => $result], $code);
    }
    ...
    {
        $return = $this->model->list_kategori();
        $this->output_json($return);
    }
    ...
    function __construct()
    {
        ...
        $this->load->model("pertandingan/kursiBerhadiahModel", 'model');
